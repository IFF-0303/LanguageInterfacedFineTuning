#!/usr/bin/env python
"""Run inference for the BERT + structured fusion classifier."""
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--model-name", default="bert-base-uncased", help="Backbone model identifier.")
...
def main() -> None:
    ...
    metadata = BertStructuredFusionClassifier.load_metadata(args.classifier_dir)
    ...
    model = BertStructuredFusionClassifier(
        ...
        model_path=str(backbone_path) if backbone_path is not None else args.model_name,
    )
