...
def csv_output_path() -> Path:
    return CSV_DIR / (
        f"run_gpt3_{args.task}_featname_{args.use_feature_name}_"
...
log_fpath = (
    EVALS_DIR
    / f"run_gpt3_{args.task}_featname_{args.use_feature_name}_incon_{args.in_context}_subset_{args.subset}_fraction_{args.subset_fraction}.txt"
)
