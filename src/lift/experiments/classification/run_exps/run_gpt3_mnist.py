...
from lift.experiments.classification.utils import mnist
...
source = f'_{args.source}'
    ...
    if is_noisy:
        ...
        test_js = str(DATA_DIR / f'{permuted}{data_name}{adv}{source}{eps}_test.jsonl')
...
log_fpath = EVALS_DIR / f'clf_gpt3_{permuted}{data_name}.txt'
